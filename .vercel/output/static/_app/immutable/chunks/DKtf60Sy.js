 ...
 */ var rt = { autoSleep: 120, force3D: 'auto', nullTargetWarn: 1, units: { lineHeight: '' } },
  ...
  Qi = function (t, e) {
    ...
    if (
      ((e._time || (!e._dur && e._initted) || (e._start < t._time && (e._dur || !e.add))) &&
        ((i = be(t.rawTime(), e)),
        (!e._dur || ce(0, e.totalDuration(), i) - e._tTime > M) && e.render(i, !0)),
  ...
  lt = function (t, e, i, r) {
    return (
      e.parent && Ot(e),
      (e._start = V((yt(i) ? i : i || t !== z ? at(t, i, e) : t._time) + e._delay)),
  ...
  Qt = function (t, e, i, r) {
    ...
    return (
      ...
      (t._dur = s),
      (t._tDur = n ? (n < 0 ? 1e10 : V(s * (n + 1) + t._rDelay * n)) : s),
  ...
  er = function (t, e) {
    ...
    return (
      !i &&
        dt(t) &&
        ((r = i = t.radius || ot),
        t.values ? ((t = ut(t.values)), (n = !yt(t[0])) && (r *= r)) : (t = We(t.increment))),
      kt(
        e,
        i
          ? L(t)
        ...
        wake: function () {
          Vi &&
            (!Be &&
              ...
              Ui(xe || _t.GreenSockGlobals || (!_t.gsap && _t) || {}),
              sr.forEach(ar)),
      ...
      if ((this !== z && h > o && r >= 0 && (h = o), h !== this._tTime || s || l)) {
        if (
          ...
          if (
            ...
            h === o
              ? ((_ = this._repeat), (c = f))
              : ((g = V(h / m)), (_ = ~~g), _ && _ === g && ((c = f), _--), c > f && (c = f)),
            (g = Kt(this._tTime, m)),
            ...
            if (
              ...
              (a = O ? 0 : h % f ? f : h),
              (this._lock = 1),
              (this.render(a || (P ? 0 : V(_ * m)), n, !f)._lock = 0),
              (this._tTime = h),
        ...
        if (
          (this._hasPause &&
            !this._forcing &&
            this._lock < 2 &&
            ((x = $r(this, V(a), V(c))), x && (h -= c - (c = x._start))),
          (this._tTime = h),
          (this._time = c),
          (this._act = !v),
          this._initted ||
    ...
    var l = t[e],
      c =
        i !== 'get'
          ...
          : L(l)
            ? f
              ? t[e.indexOf('set') || !L(t['get' + e.substr(3)]) ? e : 'get' + e.substr(3)](f)
              : t[e]()
            : l,
      d = L(l) ? (f ? pn : gr) : fi,
      p;
  ...
  ui = function u(t, e, i) {
    ...
    if (
      ...
      for (t._pt = t._ptCache = 0, o = (p && Q(o)) || (o && !p), w = 0; w < m.length; w++) {
        if (
          ((b = m[w]),
          (R = b._gsap || si(m)[w]._gsap),
          (t._ptLookup[w] = q = {}),
          Ve[R.id] && wt.length && ve(),
          (U = x === m ? w : x.indexOf(b)),
          D &&
            (A = new D()).init(b, N || g, t, U, x) !== !1 &&
            ((t._pt = O = new j(t._pt, b, A.name, 0, 1, A.render, A, 0, A.priority)),
          ...
          for (P in g)
            tt[P] && (A = dr(P, g, t, U, b, x))
              ? A.priority && (k = 1)
              : (q[P] = O = oi.call(t, b, P, 'get', g[P], U, x, 0, r.stringFilter));
        (t._op && t._op[w] && t.kill(b, t._op[w]),
          v &&
            t._pt &&
            ((vt = t), z.killTweensOf(b, q, t.globalTime(e)), (Y = !t.parent), (vt = 0)),
          t._pt && o && (Ve[R.id] = 1));
      }
...
var B = (function (u) {
  ...
  function t(i, r, n, s) {
    ...
    return (
      d === !0 && !He && ((vt = mt(a)), z.killTweensOf(v), (vt = 0)),
      lt(x, mt(a), n),
      r.reversed && a.reverse(),
      r.paused && a.paused(!0),
      (l || (!f && !p && a._start === V(x._time) && Q(l) && qr(mt(a)) && x.data !== 'nested')) &&
      ...
      if (!f) Gr(this, r, n, s);
        ...
        if (((c = l), (v = this.timeline), this._repeat)) {
          ...
          if (
            ...
            l === o
              ? ((p = this._repeat), (c = f))
              : ((m = V(l / _)), (p = ~~m), p && p === m ? ((c = f), p--) : c > f && (c = f)),
            (y = this._yoyo && p & 1),
          ...
          p !== m &&
            ...
            this.vars.repeatRefresh &&
              ...
              c !== _ &&
              this._initted &&
              ((this._lock = s = 1), (this.render(V(_ * p), !0).invalidate()._lock = 0)));
        }
        if (!this._initted) {
...
st(B.prototype, { _targets: [], _lazy: 0, _startAt: 0, _op: 0, _onInit: 0 });
        ...
        return (
          this.data.forEach(function (r) {
            return r instanceof u
              ...
              : r instanceof B && !(r.parent && r.parent.data === 'nested') && i.push(r);
          }),
          i
        );
      }),
  ...
  we = {
    ...
    exportRoot: function (t, e) {
      ...
      for (
        ...
        ((n = r._next),
          (e || !(!r._dur && r instanceof B && r.vars.onComplete === r._targets[0])) &&
 ...
 */ var Pi,
  ...
  St = function u(t, e, i, r) {
    ...
    if (d && (e === 'height' || e === 'width')) {
      ...
      ((d || s === '%') && !Vn[ft(_, 'display')] && (a.position = ft(t, 'position')),
        ...
        ? ((n = le(t, r)),
          (n =
            e !== 'transformOrigin'
              ...
              : n.svg
                ? n.origin
                : Oe(ft(t, H)) + ' ' + n.zOrigin + 'px'))
        : ((n = t.style[e]),
          (!n || n === 'auto' || r || ~(n + '').indexOf('calc(')) &&
            (n = (Pe[e] && Pe[e](t, e, i)) || ft(t, e) || qi(t, e) || (e === 'opacity' ? 1 : 0))),
  ...
  Un = function (t, e, i, r) {
    ...
    if (
      ...
      (i += ''),
      (r += ''),
      r.substring(0, 6) === 'var(--' && (r = ft(t, r.substring(4, r.indexOf(')')))),
      r === 'auto' &&
        ((_ = t.style[e]), (t.style[e] = r), (r = ft(t, e) || r), _ ? (t.style[e] = _) : Nt(t, e)),
      (h = [i, r]),
      fr(h),
      (i = h[0]),
      (r = h[1]),
  ...
  le = function (t, e) {
    ...
    return (
      ...
      i.svg &&
        ...
        je(t, Y || f, !!Y || i.originIsAbsolute, i.smooth !== !1, P)),
      (g = i.xOrigin || 0),
      (w = i.yOrigin || 0),
      P !== _e &&
        ((R = P[0]),
        ...
        P.length === 6
          ...
          : ((Mt = P[6]),
            ...
            (d = I(Math.sqrt(R * R + D * D + A * A))),
            (p = I(Math.sqrt(N * N + Mt * Mt))),
            (O = Vt(U, N)),
            (x = Math.abs(O) > 2e-4 ? O * Rt : 0),
            (T = pt ? 1 / (pt < 0 ? -pt : pt) : 0)),
        i.svg &&
          ((Y = t.getAttribute('transform')),
          (i.forceCSS = t.setAttribute('transform', '') || !Dr(ft(t, F))),
  ...
  Wn = function (t, e) {
    ...
    ((o = parseFloat(o)),
      ...
      (p || _ || m || y) &&
        ((v = I(v + p - (p * g + _ * P) + m)), (T = I(T + _ - (p * w + _ * O) + y))),
      (r || n) &&
        ((b = d.getBBox()), (v = I(v + (r / 100) * b.width)), (T = I(T + (n / 100) * b.height))),
  ...
  $n = function (t, e, i) {
    ...
    r.svg
      ...
      : ((f = getComputedStyle(i)[F]), (s[F] = e), (a = le(i, 1)), (s[F] = f));
    for (o in xt)
      ((f = r[o]),
        (h = a[o]),
        f !== h &&
          ...
          if (
            (o && _ in o
              ? ((f = typeof o[_] == 'function' ? o[_].call(i, r, t, n) : o[_]),
                ...
                G(f + '') || f === 'auto' || (f += rt.units[_] || G(gt(t, _)) || ''),
                (f + '').charAt(1) === '=' && (f = gt(t, _)))
              : (f = gt(t, _)),
            (c = parseFloat(f)),
            ...
            if (
              ...
              d === 'string' &&
                h.substring(0, 6) === 'var(--' &&
                ((h = ft(t, h.substring(4, h.indexOf(')')))), (l = parseFloat(h))),
              T ||
                ((g = t._gsap),
                (g.renderTransform && !e.parseTransform) || le(t, e.parseTransform),
                (w = e.smoothOrigin !== !1 && g.smooth),
                (T = this._pt = new j(this._pt, a, F, 0, 1, g.renderTransform, g, 0, -1)),
                (T.dep = 1)),
              _ === 'scale')
            )
              ((this._pt = new j(
