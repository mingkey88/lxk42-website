...
window.fetch = (e, t) => (
  (e instanceof Request ? e.method : t?.method || 'GET') !== 'GET' && H.delete(Ue(e)),
  It(e, t)
);
const H = new Map();
function Ut(e, t) {
...
function jt({ nodes: e, server_loads: t, dictionary: n, matchers: r }) {
  ...
  return Object.entries(n).map(([o, [c, l, d]]) => {
    const { pattern: p, params: f } = xt(o),
      u = {
        id: o,
        exec: h => {
          const w = p.exec(h);
          if (w) return Ot(w, f, r);
        },
...
const I = globalThis.__sveltekit_1lt0a6v?.base ?? '',
  $t = globalThis.__sveltekit_1lt0a6v?.assets ?? I,
  Dt = '1758190828120',
...
function ke(e, t, n) {
  ...
  const a = e instanceof SVGAElement ? e.target.baseVal : e.target,
    ...
    i = r?.origin === ue && e.hasAttribute('download');
      ...
      if (typeof o[0] == 'string') {
        ...
        switch (c) {
          ...
          case 'Set':
            const d = new Set();
            r[s] = d;
            for (let u = 1; u < o.length; u += 1) d.add(a(o[u]));
            break;
          case 'Map':
            const p = new Map();
            r[s] = p;
            for (let u = 1; u < o.length; u += 2) p.set(a(o[u]), a(o[u + 1]));
            break;
          case 'RegExp':
          ...
          case 'null':
            ...
            r[s] = f;
            for (let u = 1; u < o.length; u += 2) f[o[u]] = a(o[u + 1]);
            break;
          case 'Int8Array':
          case 'Uint8Array':
          ...
          case 'URLSearchParams': {
            const u = new URLSearchParams(o[1]);
            r[s] = u;
            break;
          }
          default:
...
const Me = {
  ...
  D = Je(Ze) ?? {},
  X = Je(Xe) ?? {},
  O = { url: Ve({}), page: Ve({}), navigating: Re(null), updated: qt() };
function Le(e) {
  D[e] = fe();
}
function fn(e, t) {
...
async function Pn(e, t, n) {
  (globalThis.__sveltekit_1lt0a6v.data && globalThis.__sveltekit_1lt0a6v?.data,
    ...
    (E = history.state?.[B]),
    (T = history.state?.[z]),
    E || ((E = T = Date.now()), history.replaceState({ ...history.state, [B]: E, [z]: T }, '')));
  const r = D[E];
  function a() {
  ...
  (n
    ...
    : (await V({
        type: 'enter',
        url: et(v.hash ? Sn(new URL(location.href)) : location.href),
        replace_state: !0,
      }),
      a()),
    kn());
...
async function pn(e, t, n, r) {
  ...
  (t.invalidateAll && (C = null),
    await V({
      ...
      nav_token: r,
      accept: () => {
        (t.invalidateAll && ((Ce = !0), (a = [...He.keys()])),
    ...
    (W.add(t),
      (C = {
        ...
        promise: ht({ ...e, preload: t }).then(
          n => (W.delete(t), n.type === 'loaded' && n.state.error && (C = null), n)
        ),
      }));
  }
  return C.promise;
...
function ie({ url: e, params: t, branch: n, status: r, error: a, route: s, form: i }) {
  ...
  else for (const u of n) u?.slash !== void 0 && (o = u.slash);
  ((e.pathname = bt(e.pathname, o)), (e.search = e.search));
  const c = {
    type: 'loaded',
    state: { url: e, params: t, branch: n, error: a, route: s },
    props: { constructors: Zt(n).map(u => u.node.component), page: $e(S) },
  };
  i !== void 0 && (c.props.form = i);
  let l = {},
    d = !S,
    p = 0;
  for (let u = 0; u < Math.max(n.length, y.branch.length); u += 1) {
    const h = n[u],
      w = y.branch[u];
    (h?.data !== w?.data && (d = !0),
...
async function Ne({ loader: e, parent: t, url: n, params: r, route: a, server_data_node: s }) {
  ...
  if (l.universal?.load) {
    let d = function (...f) {
      for (const u of f) {
        const { href: h } = new URL(u, n);
        c.dependencies.add(h);
      }
    };
    const p = {
      tracing: { enabled: !1, root: Me, current: Me },
      route: new Proxy(a, { get: (f, u) => (o && (c.route = !0), f[u]) }),
      params: new Proxy(r, { get: (f, u) => (o && c.params.add(u), f[u]) }),
      data: s?.data ?? null,
      url: Et(
        n,
        () => {
      ...
      async fetch(f, u) {
        ...
        const { resolved: h, promise: w } = dt(f, u, n);
        return (o && d(h.href), w);
      },
      setHeaders: () => {},
      depends: d,
...
async function ht({ id: e, invalidating: t, url: n, params: r, route: a, preload: s }) {
  if (C?.id === e) return (W.delete(C.token), C.promise);
  const { errors: i, layouts: o, leaf: c } = a,
    l = [...o, c];
  (i.forEach(m => m?.().catch(() => {})), l.forEach(m => m?.[1]().catch(() => {})));
  let d = null;
  const p = y.url ? e !== ce(y.url) : !1,
    f = y.route ? a.id !== y.route.id : !1,
    u = _n(y.url, n);
  let h = !1;
  const w = l.map((m, g) => {
    const b = y.branch[g],
      k = !!m?.[0] && (b?.loader !== m[1] || We(h, f, p, u, b.server?.uses, r));
    return (k && (h = !0), k);
  });
  if (w.some(Boolean)) {
    try {
  ...
  const N = l.map(async (m, g) => {
    ...
    const b = y.branch[g],
      k = A?.[g];
    if ((!k || k.type === 'skip') && m[1] === b?.loader && !We(_, f, p, u, b.universal?.uses, r))
      return b;
...
async function he({ status: e, error: t, url: n, route: r }) {
  ...
  if (v.server_loads[0] === 0)
    try {
      ...
      (n.origin !== ue || n.pathname !== location.pathname || xe) && (await G(n));
    }
  try {
    const o = await Ne({
        loader: Ae,
...
async function pe(e, t) {
  if (e && !de(e, I, v.hash)) {
    ...
    for (const a of Pe) {
      const s = a.exec(r);
      if (s) return { id: ce(e), invalidating: t, route: a, params: At(s), url: e };
    }
  }
}
function wn(e) {
...
async function V({
  ...
  const u = await pe(t, !1),
    h =
      e === 'enter'
        ? je(y, u, t, e)
        : pt({ url: t, type: e, delta: n?.delta, intent: u, event: p });
  if (!h) {
    (d(), $ === c && ($ = f));
    return;
  }
  ...
  if (((t = u?.url || t), $ !== c)) return (h.reject(new Error('navigation aborted')), !1);
  if (_.type === 'redirect') {
    if (o < 20) {
      (await V({
        type: e,
  ...
  if (
    ...
    const g = s ? 0 : 1,
      b = { [B]: (E += g), [z]: (T += g), [Qe]: i };
    ((s ? history.replaceState : history.pushState).call(history, b, '', t), s || fn(E, T));
  }
...
async function gt(e, t, n, r, a) {
  return e.origin === ue && e.pathname === location.pathname && !xe
...
function vn() {
  ...
  async function s(o, c) {
    const l = nt(o, x),
      d = l === t && c >= n;
    if (!l || d) return;
    const { url: p, external: f, download: u } = ke(l, I, v.hash);
    if (f || u) return;
    const h = te(l),
      w = p && ce(y.url) === ce(p);
    if (!(h.reload || w))
...
function kn() {
  ((history.scrollRestoration = 'manual'),
    ...
    x.addEventListener('click', async t => {
      ...
      if (d !== void 0 && p) {
        ...
        if (((K = !0), Le(E), e(r), !o.replace_state)) return;
        K = !1;
      }
      (t.preventDefault(),
        await new Promise(f => {
    ...
    addEventListener('popstate', async t => {
      if (!Se) {
        if (t.state?.[B]) {
          ...
          if (i === T && (it || o)) {
            (a !== S.state && (S.state = a), e(s), (D[E] = fe()), r && scrollTo(r.x, r.y), (E = n));
            return;
          }
          const l = n - E;
          await V({
    ...
    addEventListener('hashchange', () => {
      K &&
        ((K = !1), history.replaceState({ ...history.state, [B]: ++E, [z]: T }, '', location.href));
    }));
  ...
  function e(t) {
    ((y.url = S.url = t), O.page.set($e(S)), O.page.notify());
  }
}
async function An(
  e,
  ...
  (({ params: a = {}, route: s = { id: null } } = (await pe(l, !1)) || {}),
    (d = Pe.find(({ id: u }) => u === s.id)));
  let p,
    f = !0;
  try {
    const u = r.map(async (w, A) => {
        const _ = o[A];
        return (
          ...
          Ne({
            ...
            parent: async () => {
              const N = {};
              for (let R = 0; R < A; R += 1) Object.assign(N, (await u[R]).data);
              return N;
            },
    ...
    if (u instanceof Te) {
      await G(new URL(u.location, location.href));
      return;
    }
    ((p = await he({
      status: ne(u),
      error: await M(u, { url: l, params: a, route: s }),
      url: l,
      route: s,
    })),
      (e.textContent = ''),
  ...
  (p.props.page && (p.props.page.state = {}), ft(p, e, f));
}
...
`);
        ...
        if (((l = l.slice(f + 1)), u.type === 'redirect')) return s(u);
        if (u.type === 'data')
          (u.nodes?.forEach(h => {
          ...
          const { id: h, data: w, error: A } = u,
            _ = i.get(h);
          (i.delete(h), A ? _.reject(c(A)) : _.fulfil(c(w)));
        }
      }
    }
  });
...
export { Pn as a, Tn as l, S as p, O as s };
