<script>
  // Simplified visual-first hero inspired by 8traordinary approach
</script>
...
<section class="hero-section min-h-screen flex items-center relative overflow-hidden">
  ...
  <div class="container-custom relative z-10">
    <div class="max-w-4xl">
      ...
      <h1 class="text-7xl lg:text-9xl font-bold text-lxk-warm-gray leading-[0.9] mb-8">
        Your Creative
        <span class="text-lxk-peach">Kakis</span>
      </h1>

      <!-- Single powerful value proposition -->
      <p class="text-3xl text-gray-700 leading-relaxed mb-12 max-w-3xl font-light">
        Singapore businesses grow faster with genuine creative partnerships.
      </p>

      <!-- Single primary CTA -->
      <a href="#/contact"
         class="inline-flex items-center bg-lxk-peach text-white px-12 py-6 rounded-full hover:bg-lxk-coral transition-all duration-300 font-medium text-xl shadow-xl hover:shadow-2xl group">
  ...
  <div class="absolute bottom-16 right-16 hidden lg:block">
    <div class="bg-white/90 backdrop-blur-sm rounded-2xl p-6 text-center shadow-xl">
      <div class="text-3xl font-bold text-lxk-peach mb-1">150%</div>
