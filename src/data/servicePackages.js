...
export const webDesignPackages = [
  ...
  },
  {
    ...
    included: [
      ...
      'Complete training program for team',
...
export const webAppPackages = [
  {
    ...
    tier: 'starter',
    description: 'Launch your idea with a solid foundation',
    price: 8800,
    timeline: '4-6 weeks',
    icon: '🏗️',
    features: [
...
export const digitalMarketingPackages = [
  ...
  },
  {
    ...
    name: 'Growth Engine',
    tier: 'professional',
    description: 'Accelerate your digital growth',
    price: 3200,
    timeline: 'Monthly',
    icon: '📈',
    popular: true,
  ...
  },
  {
    ...
    name: 'Market Leader',
    tier: 'enterprise',
    description: 'Dominate your market digitally',
    price: 'Custom Quote',
    timeline: 'Monthly',
    icon: '👑',
    features: [
...
export const brandingPackages = [
  {
    ...
    tier: 'starter',
    description: 'Core identity for your brand',
    price: 2200,
    timeline: '2-3 weeks',
    icon: '🎨',
    features: [
...
export const graphicDesignPackages = [
  {
    ...
    name: 'Design Basics',
    tier: 'starter',
    description: 'Essential marketing materials',
    price: 800,
    timeline: '1-2 weeks',
    icon: '📄',
    features: [
  ...
  },
  {
    ...
    tier: 'professional',
    description: 'Complete marketing materials',
    price: 1800,
    timeline: '2-3 weeks',
    icon: '📊',
    popular: true,
...
export const motionGraphicsPackages = [
  {
    id: 'animated-basics',
    name: 'Animated Basics',
    tier: 'starter',
    description: 'Simple animations for social media',
    price: 1200,
    timeline: '1-2 weeks',
    icon: '🎬',
    features: [
...
export const getPackagesByService = (service) => {
  const packageMap = {
