...
<section class="section-padding bg-gradient-to-br from-white to-lxk-cream/30">
  <div class="container-custom">
    <div class="text-center mb-12">
      <h2 class="text-3xl md:text-4xl font-bold text-lxk-warm-gray mb-4">Service Packages</h2>
    ...
    {#if packages.length > 0}
          ...
          <div class="relative group">
            ...
            {#if pkg.popular}
              <div class="absolute -top-4 left-1/2 transform -translate-x-1/2 z-10">
                <span
                  class="bg-gradient-to-r from-lxk-peach to-lxk-coral text-white px-4 py-2 rounded-full text-sm font-semibold shadow-lg"
                >
                  Most Popular 🌟
                </span>
              </div>
            ...
            <!-- Package Card -->
            <div
              class="relative h-full painterly-card p-8 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 {pkg.popular
                ? 'ring-2 ring-lxk-peach/30'
                : ''}"
            >
              <!-- Background Gradient -->
              <div
                class="absolute inset-0 bg-gradient-to-br {getPackageColor(
                  pkg.tier
              ...
              <div class="relative z-10">
                ...
                <div class="text-center mb-8">
                  <div
                    class="inline-flex px-4 py-2 mx-auto mb-4 bg-gradient-to-r {getPackageColor(
                      pkg.tier
                    )} rounded-full"
                  >
                    <span class="text-white text-sm font-semibold tracking-wider uppercase"
                      >{pkg.tier_badge}</span
                    >
                  </div>
                ...
                <div class="space-y-3 mb-8">
                  {#each pkg.features as feature}
                    <div class="flex items-start gap-3">
                      <div
                        class="w-5 h-5 bg-lxk-sage/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5"
                      >
                ...
                <div class="space-y-3">
                  <button
                    class="w-full bg-gradient-to-r {getPackageColor(
                      pkg.tier
                    )} text-white py-3 px-6 rounded-xl font-semibold hover:shadow-lg hover:scale-105 transition-all duration-300"
                  >
                    Choose {pkg.name}
                  </button>
      ...
      <div class="text-center mt-12">
        <div
          class="inline-block p-6 bg-gradient-to-br from-lxk-cream to-white rounded-2xl shadow-lg"
        >
          ...
          <button
            class="bg-gradient-to-r from-lxk-sage to-lxk-soft-teal text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg hover:scale-105 transition-all duration-300"
          >
