<script>
  ...
  const relevantProjects = projects.filter(
    project =>
      project.tags.includes('motion graphics') ||
      project.tags.includes('animation') ||
  ...
  <div class="container-custom">
    <div class="text-center mb-6 md:mb-8 animate-on-scroll relative">
      ...
      <p class="text-xl text-gray-600 max-w-3xl mx-auto">
        Motion that feels alive — from subtle micro‑interactions to story‑driven explainers.
      </p>
    ...
    <div id="motion-overview" class="grid md:grid-cols-3 gap-8">
      <div class="painterly-card p-8 animate-on-scroll">
        ...
        <p class="text-gray-700">
          Clear, engaging videos that explain your products, services, or concepts with warmth and
          personality.
        </p>
      </div>
      <div class="painterly-card p-8 animate-on-scroll">
        ...
        <p class="text-gray-700">
          Breathe life into your brand elements with subtle animations that enhance recognition and
          memorability.
        </p>
      </div>
      <div class="painterly-card p-8 animate-on-scroll">
        ...
        <p class="text-gray-700">
          Eye-catching animations optimized for Instagram, LinkedIn, TikTok, and other social
          platforms.
        </p>
      </div>
    </div>
    ...
    <div id="animation-types" class="mt-16 animate-on-scroll">
      <h3 class="text-2xl font-semibold text-lxk-sage mb-8 text-center">
        Types of Animation We Create
      </h3>
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div class="painterly-card p-6 text-center">
          <div
            class="w-16 h-16 bg-gradient-to-br from-lxk-sage/20 to-lxk-mint/20 rounded-xl flex items-center justify-center mx-auto mb-4"
          >
        ...
        <div class="painterly-card p-6 text-center">
          <div
            class="w-16 h-16 bg-gradient-to-br from-lxk-peach/20 to-lxk-coral/20 rounded-xl flex items-center justify-center mx-auto mb-4"
          >
        ...
        <div class="painterly-card p-6 text-center">
          <div
            class="w-16 h-16 bg-gradient-to-br from-lxk-coral/20 to-lxk-sage/20 rounded-xl flex items-center justify-center mx-auto mb-4"
          >
            <div class="text-2xl">📱</div>
          </div>
        ...
        <div class="painterly-card p-6 text-center">
          <div
            class="w-16 h-16 bg-gradient-to-br from-lxk-mint/20 to-lxk-peach/20 rounded-xl flex items-center justify-center mx-auto mb-4"
          >
            <div class="text-2xl">💻</div>
          </div>
        ...
        <div class="painterly-card p-6 text-center">
          <div
            class="w-16 h-16 bg-gradient-to-br from-lxk-sage/20 to-lxk-coral/20 rounded-xl flex items-center justify-center mx-auto mb-4"
          >
            <div class="text-2xl">📊</div>
          </div>
        ...
        <div class="painterly-card p-6 text-center">
          <div
            class="w-16 h-16 bg-gradient-to-br from-lxk-peach/20 to-lxk-mint/20 rounded-xl flex items-center justify-center mx-auto mb-4"
          >
            <div class="text-2xl">🎨</div>
          </div>
    ...
    <div id="performance" class="mt-16 animate-on-scroll">
      ...
      <div class="painterly-card p-6">
        ...
        <div class="text-xs text-gray-500 mt-3 text-center">
          Average performance improvements with video content for our Singapore clients
        </div>
      </div>
    </div>
